<footer class="w-full py-14">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div
			class="border-b border-gray-200 pb-14 flex justify-between items-center flex-col gap-8 lg:gap-0 lg:flex-row"
		>
			<div class="block">
			...
			<div class="flex items-center flex-col gap-4 lg:flex-row">
				...
				/>
				<button class="h-14 py-3.5 px-7 bg-indigo-600 shadow-sm rounded-full text-white font-bold"
					>Subscribe</button
				>
			</div>
		</div>
		...
		>
			...
			<div class="lg:mx-auto text-left">
				<h4 class="text-lg text-gray-900 font-medium mb-7">MakerStudio</h4>
				<ul class="text-sm transition-all duration-500">
					<li class="mb-6">
						<a href="javascript:;" class="text-gray-600 whitespace-nowrap hover:text-gray-900"
							>Home</a
						>
					</li>
					<li class="mb-6">
			...
			<div class="lg:mx-auto text-left">
				...
				<ul class="text-sm transition-all duration-500">
					...
					<li class="mb-6">
						<a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Plugin Guide</a>
					</li>
				</ul>
			</div>
			<!--End Col-->
		...
		<div class="py-7 border-t border-gray-200">
			<div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
				<span class="text-sm text-gray-500"
					>©<a href="https://pagedone.io/">MakerStudio</a>2024, All rights reserved.</span
				>
